...
namespace MaichartConverterUnitTest
{
    ...
    public class ChartTest
    {
        ...
        public void GetBPMTimeUnitTest1()
        {
            ...
            Assert.AreEqual(expected, GetBPMTimeUnit(bpm));
        }
        ...
        {
            double expected = GetBPMTimeUnit(60) * 384;
            Chart chart = new Ma2();
            chart.BPMChanges = new BPMChanges();
            chart.BPMChanges.Add(new BPMChange(0, 0, 60.0));
        ...
        public void GetTimeStampTest60to120to240()
        {
            ...
            double expected = GetBPMTimeUnit(60) * 384 + GetBPMTimeUnit(120) * 384 + GetBPMTimeUnit(240) * 384;
            int bar3Tick = 384 * 3;
        ...
        public void GetTimeStampTestNoteSlideBar0Tick192()
        {
            ...
            double expectedWait = GetBPMTimeUnit(60) * (192 + 24);
            double expectedLast = GetBPMTimeUnit(60) * (192 + 24 + 96);
            int bar0Tick192 = 192;
