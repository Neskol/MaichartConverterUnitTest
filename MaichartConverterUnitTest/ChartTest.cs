...
namespace MaichartConverterUnitTest
{
    ...
    public class ChartTest
    {
        ...
        public void ChartGetBPMTimeUnitTest1()
        {
            ...
            Assert.AreEqual(expected, GetBPMTimeUnit(bpm, Definition));
        }
        ...
        {
            double expected = GetBPMTimeUnit(60, Definition) * 384;
            Chart chart = new Ma2();
            chart.BPMChanges = new BPMChanges();
            chart.BPMChanges.Add(new BPMChange(0, 0, 60.0));
        ...
        public void GetTimeStampTest60To120()
        {
            ...
            double expected = GetBPMTimeUnit(60, Definition) * 384 + GetBPMTimeUnit(120, Definition) * 384;
        ...
        public void GetTimeStampTest60to120to240()
        {
            ...
            double expected = GetBPMTimeUnit(60, Definition) * 384 + GetBPMTimeUnit(120, Definition) * 384 +
                              GetBPMTimeUnit(240, Definition) * 384;
            int bar3Tick = 384 * 3;
        ...
        public void GetTimeStampTest60to120to240withTick3B24Tick()
        {
            ...
            chart.BPMChanges.Add(new BPMChange(2, 0, 240.0));
            double expected = GetBPMTimeUnit(60, Definition) * 384 + GetBPMTimeUnit(120, Definition) * 384 +
                              GetBPMTimeUnit(240, Definition) * 384 + GetBPMTimeUnit(240, Definition) * 24;
        ...
        public void GetTimeStampTestZeroWithBPMChange()
        {
            ...
            Assert.AreEqual(expected, GetTimeStamp(x, 0, Definition));
        }
        ...
        public void ChartGetTimeStampTestNoteTapBar0Tick192()
        {
            ...
            chart.Notes.Add(x);
            chart.Update();
            double expected = GetBPMTimeUnit(60, Definition) * 192;
            int bar0Tick192 = 192;
        ...
        public void ChartGetTimeStampTestNoteSlideBar0Tick192()
        {
            ...
            chart.Update();
            double expectedTick = GetBPMTimeUnit(60, Definition) * 192;
            double expectedWait = GetBPMTimeUnit(60, Definition) * (192 + 24);
            double expectedLast = GetBPMTimeUnit(60, Definition) * (192 + 24 + 96);
            int bar0Tick192 = 192;
        ...
        public void TestUpdateNoteTypeChange()
        {
            ...
            BPMChange changeNote = new(0, 0, 120.0);
        ...
        {
            Ma2 candidate = new("../../../data/011568_03.ma2");
            // LINQ for TAP
