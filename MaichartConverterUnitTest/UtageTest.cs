...
namespace MaichartConverterUnitTest
{
    ...
    public class UtageTest
    {
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000-Utage/music/music000363/000363_00.ma2");
            Simai candidate = new(test);
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000-Utage/music/music000846/000846_00.ma2");
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000-Utage/music/music000145/000145_00.ma2");
            // Console.WriteLine(test.Compose());
            Console.WriteLine(new Simai(test).Compose());
            Assert.IsNotNull(test);
        }
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000/music/music010363/010363_03.ma2");
            Console.WriteLine(new Simai(test).Compose());
            Assert.IsNotNull(test);
        }
        ...
        {
            Ma2 test = new("../../../data/OshamaDXBar6.ma2");
            Console.WriteLine(new Simai(test).Compose());
            Assert.IsNotNull(test);
        }
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000/music/music010363/010363_03.ma2");
            StreamWriter sw = new("../../../data/DX363BeforeRotate.txt", false);
            sw.WriteLine(test.Compose());
            sw.Close();
            test.RotateNotes(FlipMethod.UpSideDown);
            StreamWriter sw2 = new("../../../data/DX363AfterRotate.txt", false);
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000/music/music010363/010363_03.ma2");
            StreamWriter sw = new("../../../data/DX363BeforeOffset.txt", false);
            sw.WriteLine(test.Compose());
            sw.Close();
            test.ShiftByOffset(384);
            StreamWriter sw2 = new("../../../data/DX363AfterOffset.txt", false);
            sw2.WriteLine(test.Compose());
            sw2.Close();
            Console.WriteLine(new Simai(test).Compose());
            Assert.IsNotNull(test);
        ...
        {
            Ma2 test = new("/Users/Neskol/MaiAnalysis/A000/music/music010363/010363_03.ma2");
            StreamWriter sw = new("../../../data/DX363Before1-96Offset.txt", false);
            sw.WriteLine(test.Compose());
            sw.Close();
            test.ShiftByOffset(1, 96);
            StreamWriter sw2 = new("../../../data/DX363After1-96Offset.txt", false);
            sw2.WriteLine(test.Compose());
            sw2.Close();
            Console.WriteLine(new Simai(test).Compose());
            Assert.IsNotNull(test);
